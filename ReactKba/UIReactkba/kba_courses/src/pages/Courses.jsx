...
const Courses = () => {
  const {id}=useParams();
  const [coures,setCourse]=useState(null);
  ...
  return (  
    ...
    <div className="flex flex-row justify-end gap-4 mr-[205px] ">
      <Link to={`/Updatecourse/${coures.courseId}`}  className="flex bg-blue-500 hover:bg-blue-600 text-white font-bold  rounded-full h-10 w-32 focus:outline-none focus:shadow-outline justify-center items-center">Edit Course</Link>
      ...
      onClick={(()=>alert)('Removed Course Funtionality is not implemented')}
